...
$('#top-left-logo').attr("src","templates/climap/img/logo.png");
...
$('#top-right-logo').attr("src","templates/climap/img/logoMinDef.png");
...
gestorMenu.addPlugin("leaflet","https://cdnjs.cloudflare.com/ajax/libs/leaflet/1.4.0/leaflet.js", function() {
	...
	gestorMenu.addPlugin("ZoomHome","templates/climap/js/leaflet-zoomhome/dist/leaflet.zoomhome.min.js");
	// Leaflet Bing Layer
	gestorMenu.addPlugin("BingLayer","templates/climap/js/leaflet-bing-layer-gh-pages/leaflet-bing-layer.js");
	// <!-- Leaflet Minimap plugin -->
	// gestorMenu.addPlugin("minimap","templates/climap/js/leaflet-minimap/Control.MiniMap.js");
	// <!-- Leaflet Locate plugin -->
	gestorMenu.addPlugin("locate","templates/climap/js/leaflet-locate/L.Control.Locate.min.js");
	// <!-- Leaflet Mouse Position plugin -->
	gestorMenu.addPlugin("MousePosition","templates/climap/js/leaflet-mouseposition/src/L.Control.MousePosition.js");
	// <!-- Leaflet Measure plugin --> 
	gestorMenu.addPlugin("Measure","templates/climap/js/leaflet-measure/leaflet-measure.js");
	// <!-- Leaflet EasyPrint plugin -->
	gestorMenu.addPlugin("EasyPrint","templates/climap/js/leaflet-easyPrint/bundle.js");
	// <!-- Leaflet Control.FullScreen plugin -->
	// gestorMenu.addPlugin("FullScreen","templates/climap/js/leaflet-fullscreen/Control.FullScreen.js");
	// <!-- Leaflet BetterWMS -->
	gestorMenu.addPlugin("betterWMS","templates/climap/js/leaflet-wms/leaflet.wms.js");
	// <!-- Leaflet Draw -->  
	gestorMenu.addPlugin("Draw","https://cdnjs.cloudflare.com/ajax/libs/leaflet.draw/1.0.4/leaflet.draw.js");
	// <!-- Leaflet SimpleGraticule -->
	gestorMenu.addPlugin("graticula","templates/climap/js/leaflet-simplegraticule/L.SimpleGraticule.js");
	//<!-- Leaflet RAinviewer -->
	gestorMenu.addPlugin("rainviewer", "templates/climap/js/Leaflet.Rainviewer-master/leaflet.rainviewer.js")
});
...
var unordered = '';
var ordered = ['','','','','','','','','',''];
var ordenZoomHome = 1; var ordenLocate = 2; var ordenFullScreen = 3; var ordenGraticula = 4; var ordenMeasure = 5; var ordenDraw = 6; var ordenBetterScale = 7; var ordenMinimap = 8; var ordenRainviewer = 9;
...
$("body").on("pluginLoad", function(event, plugin){
	...
	switch(plugin.pluginName) {
		...
		case 'FullScreen':
			...
			break;
		case 'rainviewer':
			ordered.splice(ordenRainviewer, 1, plugin.pluginName);
			break;
		default :
	...
	if(visiblesActivar && gestorMenu.pluginExists('rainviewer')) {
		if(gestorMenu.plugins['rainviewer'].getStatus() == 'ready' || gestorMenu.plugins['rainviewer'].getStatus() == 'fail'){
		} else { visiblesActivar = false; }
	}
	if(visiblesActivar){
			...
			switch (e) {
				...
				case 'rainviewer':
					...
					var rainviewer = L.control.rainviewer({
						...
						nextButtonText: '>',
						playStopButtonText: 'Iniciar/Detener',
						position: 'topleft',
						prevButtonText: '<',
						positionSliderLabelText: "Tiempo:",
						opacitySliderLabelText: "Opacidad:",
						animationInterval: 500,
						opacity: 0.5
					});
					rainviewer.addTo(mapa);
					
					gestorMenu.plugins['rainviewer'].setStatus('visible');
					break;
				case 'locate':
